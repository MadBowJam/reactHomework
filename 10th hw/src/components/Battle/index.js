    ...
    render() {
        ...
        return (
            <div className='main_wrapper'>
                <Box sx={{ display: 'grid', gridTemplateColumns: '240px 240px',gap: 3 }}>
                    {!playerOneName ?
                ...
                <Button variant="contained" href='/battle/results' className='button' sx={{ width:'200px',height:'56px' }}>Battle Results</Button>
                }
            </div>
        )
    }
